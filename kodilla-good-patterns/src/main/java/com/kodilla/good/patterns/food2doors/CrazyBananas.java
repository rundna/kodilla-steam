...
public class CrazyBananas implements Shop {

    public void process(OrderItem order) {
        HashMap<String, Integer> inventory = new HashMap<>();
        inventory.put("banana", new Random().nextInt(order.getQuantity()+10));
        inventory.put("apple", new Random().nextInt(order.getQuantity()+10));
        inventory.put("mango", new Random().nextInt(order.getQuantity()+10));
        inventory.put("maracuja", new Random().nextInt(order.getQuantity()+10));
        inventory.put("tangerine", new Random().nextInt(order.getQuantity()+10));
        inventory.put("avocado", new Random().nextInt(order.getQuantity()+10));
        inventory.put("broccoli", new Random().nextInt(order.getQuantity()+10));
        inventory.put("pineapple", new Random().nextInt(order.getQuantity()+10));
        inventory.put("strawberries", new Random().nextInt(order.getQuantity()+10));
